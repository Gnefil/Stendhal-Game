...
public class FurnitureSellerNPC implements ZoneConfigurator {
	...
	private void buildNPC(final StendhalRPZone zone) {
		final SpeakerNPC npc = new SpeakerNPC("Oakheart");
		...
		final Map<String, Integer> pricesBuy = shops.get("deniranfurniturebuy");
		...
		npc.addGreeting("Welcome to Deniran's furniture shop.");
		npc.addJob("I am the local furniture dealer. And it looks like you need some redecorating. Ask me about my #prices.");
		npc.addHelp("If you would like to sell something, ask me about my #prices and I will tell you what I have.");
		npc.addQuest("I have no quests, but you can"
				+ " just ask and I'll tell you the #prices I pay for my delighted pieces of furniture.");
		...
		npc.add(ConversationStates.ANY,
				...
				new MultipleActions(
						...
						new SayTextAction("Please come again, maybe next time I'll have more furniture.")
				)
		);
		...
		npc.setOutfit(new Outfit("body=7,head=6,mouth=4,eyes=1,dress=34,mask=2,hair=3"));
